...
Гибко настраиваемое извлечение предикатно-аргументных структур из текста с опорой на дерево разбора spaCy.

## Функционал

- **Гибкая настройка правил** 
  - для сборки многокомпонентных предикатов:
  ...
  - для включения / исключения из числа аргументов поддеревьев разбора
  - для разбиения многопредикатных высказываний на отдельные предикатные структуры
